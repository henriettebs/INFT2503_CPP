...
public:
    ...
    public:
        ...
        virtual string piece_string() const = 0;
    };
    ...
    public:
        ...
        {
            int diffX = abs(from_x - to_x);
            int diffY = abs(from_y - to_y);
            if ((diffX == 1 && diffX < 2) || (diffY == 1 && diffY < 2))
                return true;

            return false;
        }

        string piece_string() const
        {
